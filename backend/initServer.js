 ...
 */
async function main() {
  console.log("Step - 1 : Enrolling hospital-1==========================");
  await enrollAdminHosp1();
  console.log("Step - 2 : Enrolling hospital-2==========================");
  await enrollAdminHosp2();
  console.log("Step - 3 : init ledger==========================");
  await initLedger();
  //await initRedis();
  console.log("Step - 4 :  register and enroll doctor==========================");
