...
exports.registerUser = async function(attributes) {
  ...
  try {
    ...
    if (hospitalId === 1) {
      ...
      const caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp3.spondon.com');
...
exports.getAllDoctorsByHospitalId = async function(networkObj, hospitalId) {
  ...
  try {
    ...
    if (hospitalId === 1) {
      ...
      const ccp = buildCCPHosp3();
      caClient = buildCAClient(FabricCAServices, ccp, 'ca.org3.example.com'/* 'ca.hosp3.spondon.com' */);
    }
